...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        "Script to generate instructions or training data for LLM fine-tuning"
    )
    group = parser.add_mutually_exclusive_group()

    # Adding optional argument
    group.add_argument(
        "-i", "--instructions", action="store_true", help="Generate Instructions"
    )
    group.add_argument(
        "-t",
        "--training",
        action="store_true",
        help="Generate Training and Validation Data",
    )
